...
public class BoardServiceTests {
	...
	private BoardService service; // 인터페이스를 필드로 선언 함
	...
	public void testExist() {
		...
		log.info("=================================");
		log.info(service); // 인터페이스를 호출해보다.
		assertNotNull(service); // 빈객체가 아님을 테스트한다.
		log.info("=================================");
		
		// org.mbc.service.BoardServiceImpl@3c78e551
		// 인터페이스를 호출했는데 구현클래스가 호출됨을 확인했다.
	...
	public void testUpdate() {
		...
		BoardVO board = service.get(1L); // 1번 게시물 가져와

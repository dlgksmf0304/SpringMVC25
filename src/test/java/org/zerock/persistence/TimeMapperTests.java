...
public class TimeMapperTests {
	...
	public void testGetTime() {
		...
		log.info("타입메퍼 테스트 getname : " + timeMapper.getClass().getName());
		log.info("타입메퍼 결과 : " + timeMapper.getTime());
	}
	
	@Test
	public void testGetTime2() {
		// 인터페이스 추상메서드 메퍼로 xml을 사용함
		log.info("타입메퍼2 테스트 getname : " + timeMapper.getClass().getName());
		log.info("타입메퍼2 결과 : " + timeMapper.getTime2());
	}
	
	@Test
	public void testGetTime2Log4jdbc() {
		// 인터페이스 추상메서드 메퍼로 xml을 사용함
		log.info("타입메퍼2 테스트 getname");
